          ...
          },
          {
            ...
            options: {
              ...
              delimiters: [
                ...
                {left: "\\begin{flalign}", right: "\\end{flalign}", display: true}
              ],
              fleqn: false,
              leqno: false,
              maxSize: 10,
              ...
              macros: {
                ...
                // Pattern Recognition and Symbolic Logic
                "\\mathbb{P}": "\\mathbb{P}",
                "\\mathbb{R}": "\\mathbb{R}",
                "\\mathbb{C}": "\\mathbb{C}",
                "\\mathbb{N}": "\\mathbb{N}",
                ...
                "\\xrightarrowtail": "\\xrightarrowtail",
                "\\xleftarrowtail": "\\xleftarrowtail",
                "\\xlooparrowright": "\\xlooparrowright",
                "\\xlooparrowleft": "\\xlooparrowleft",
                "\\xrightleftarrows": "\\xrightleftarrows",
                "\\xleftrightarrows": "\\xleftrightarrows",
                "\\xrightequilibrium": "\\xrightequilibrium",
                "\\xleftequilibrium": "\\xleftequilibrium",
                "\\xRightarrow": "\\xRightarrow",
                "\\xLeftarrow": "\\xLeftarrow",
                "\\xLeftrightarrow": "\\xLeftrightarrow",
                "\\xhookrightarrow": "\\xhookrightarrow",
